...
function Hero() {
  ...
  return (
    <motion.div
      ...
      className="pt-5"
    >
      <section className="flex flex-col md:flex-row items-center justify-center md:justify-around p-8">
          ...
          <div className="max-w-2xl flex flex-col">
            ...
            <Link to="/login" className={getLinkClass("/login")} onClick={() => handleLinkClick("/login")}>
              <motion.button
                ...
                className="text-white px-8 text-sm py-2 bg-primary hover:bg-secondary shadow-lg shadow-primary/40  rounded-full"
              >
                Get Started
              </motion.button>
            </Link>
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.8 }}
          className="flex items-center justify-center rounded-md shadow-2xl shadow-primary/40 lg:w-[360px] lg:h-[360px] md:w-[300px] md:h-[300px] w-[200px] h-[200px] overflow-hidden"
        >
          <img
            src="/homepage.jpg"
            alt="Solar Energy"
